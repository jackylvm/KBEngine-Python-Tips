...
def accountLoginResponse(commitName, realAccountName, extraDatas, errorCode):
    ...
    :param errorCode:integer，错误码。如果需要中断用户的行为可在此设置错误码，错误码可参考（KBEngine.SERVER_ERROR_*， 描述在kbengine/kbe/res/server/server_errors.xml），否则提交KBEngine.SERVER_SUCCESS代表允许此处登陆。
    :return:
    """
    pass
